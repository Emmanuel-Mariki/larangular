        ...
        execute: function() {
            LoginComponent = (function () {
                ...
                LoginComponent.prototype.login = function () {
                    var _this = this;
                    this.LoginService.getCredentials(this.LoginForm.controls['username'].value, this.LoginForm.controls['password'].value)
                ...
                LoginComponent.prototype.buildForm = function () {
                    ...
                    this.LoginForm = this.fomBuilder.group({
                        username: this.fomBuilder.control(null, forms_1.Validators.required),
                ...
                LoginComponent = __decorate([
                    core_1.Component({
                        selector: 'app-login',
                        templateUrl: './larangular/resources/assets/typescript/leoleo/login/login.html',
