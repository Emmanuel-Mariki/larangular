    ...
    return {
        ...
        execute: function() {
            CategoryService = (function () {
                ...
                CategoryService.prototype.ThrowError = function (error) {
                ...
                CategoryService.prototype.putCategory = function (id, PropertyTypes) {
                ...
                CategoryService.prototype.postCategory = function (PropertyTypes) {
                    var body = JSON.stringify({ PropertyTypes: PropertyTypes });
                    var options = new http_1.RequestOptions({ headers: this.headers });
