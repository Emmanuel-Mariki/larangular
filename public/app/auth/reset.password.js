            ...
            ResetPasswordComponent = (function () {
                ...
                ResetPasswordComponent.prototype.buildForm = function () {
                    ...
                    this.LoginForm = this.fomBuilder.group({
                        ...
                        password: this.fomBuilder.control(null, forms_1.Validators.compose([forms_1.Validators.required])),
                ...
                ResetPasswordComponent.prototype.onValueChanged = function (data) {
                    if (!this.LoginForm) {
                        return;
                    }
                ...
                ResetPasswordComponent = __decorate([
                    core_1.Component({
                        selector: 'app-login',
                        templateUrl: './larangular/resources/assets/typescript/auth/reset.html',
