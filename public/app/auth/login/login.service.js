        ...
        execute: function () {
            ...
            LoginService = (function () {
                function LoginService(http) {
                    this.http = http;
                    this.URL = 'http://localhost/larangular/login';
                    this.headers = new http_1.Headers({ 'Content-Type': 'application/jsonp', 'X-CSRF-TOKEN': this.getToken() });
                }
                LoginService.prototype.getToken = function () {
                    return document.querySelector('meta[property="csrf-token"]')['content'];
                };
                LoginService.prototype.getCredentials = function (Login) {
