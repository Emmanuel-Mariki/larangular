System.register(["@angular/core", '@angular/router', "@angular/forms", './type.service', './type'], function(exports_1, context_1) {
    ...
    var core_1, router_1, forms_1, type_service_1, type_1;
    var TypeViewComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            TypeViewComponent = (function () {
                ...
                TypeViewComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [router_1.ActivatedRoute, router_1.Router, forms_1.FormBuilder, type_service_1.TypeService])
                ], TypeViewComponent);
